        ...
        For Each ctl As Control In thisCtrl.Controls
            Try
                If Not IsNothing(ctl.Parent) Then
                    ...
                    c.topOffsetPercent = CDbl(ctl.Top) / CDbl(parentHeight)
                    c.leftOffsetPercent = CDbl(ctl.Left) / CDbl(parentWidth)
                    c.heightPercent = CDbl(ctl.Height) / CDbl(parentHeight)
                    c.widthPercent = CDbl(ctl.Width) / CDbl(parentWidth)
